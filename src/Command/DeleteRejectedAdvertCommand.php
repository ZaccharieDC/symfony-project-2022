...
#[AsCommand(
    name: 'advert:delete-rejected',
    description: 'Allows you to delete rejected adverts, created X time ago',
)]
class DeleteRejectedAdvertCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $this->advertRepository->removeRejected($date, true);

            $io->success('All rejected adverts have been removed.');
